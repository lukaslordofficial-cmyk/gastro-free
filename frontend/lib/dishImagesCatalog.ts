...
export const SOUPS_PL_CATALOG: DishImageEntry[] = [
  ...
  { slug: 'gazpacho', category: 'kuchnia_polska', labelPl: 'Gazpacho', aliases: ['gazpacho'], storagePath: 'dania/soups_pl/soup_pl_25.webp', localAsset: require('@/assets/premium/dishes/soups_pl/soup_pl_25.webp') },
];
